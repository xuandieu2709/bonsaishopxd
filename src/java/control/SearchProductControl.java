 ...
 * @author TG
 */
@WebServlet(name = "SearchProductControl", urlPatterns = {"/SearchProduct"})
public class SearchProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Product> list = dao.searchByNameProducts(txt);
        ...
        if (list == null) {
            request.setAttribute("mess", "Tên sản phẩm cần tìm không tồn tại!");
