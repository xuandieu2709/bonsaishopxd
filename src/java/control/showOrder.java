...
public class showOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // Them don hang vao cookies neu khach khong dang nhap tai khoan
        DAO dao = new DAO();
        String idCus ="";
        Cookie[] cook = request.getCookies(); // tạo mang arr lay tat ca cac gia tri trong cookies
        for(Cookie o:cook){
            if(o.getName().equals("idCus"))
            idCus += o.getValue();
        }
        List<Order> list = dao.getAllOrderByIDCustommer(idCus);
