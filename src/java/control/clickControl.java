 ...
 * @author TG
 */
@WebServlet(name = "clickControl", urlPatterns = {"/clickControl"})
public class clickControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        int count = dao.CountAllProductsByIDCatalory(id); // Ma Nghanh
        int end = count/10;
        if(count % 10 != 0){
            end++;
        }
        ...
        // page
        List<Product> list = dao.pageProductByIdCatagory(index,id);
